...
const Ticket = () => {
  ...
  const handleDownloadButtonClick = () => {
    ...
    originalImage.onload = () => {
      ...
      tempContext.fillText(displayedName, 1150, 330);
      ...
      tempContext.arc(originalImage.width - 1420 + 240, 46 + 240, 190, 0, Math.PI * 2);
      tempContext.closePath();
      tempContext.clip();

      tempContext.drawImage(userImage, originalImage.width - 1420, 46, 480,480);
